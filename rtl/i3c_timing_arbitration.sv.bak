...
module i3c_timing_arbitration #(
    ...
    parameter integer tSCL_MIN_HIGH   = 60,   
    parameter integer tSCL_MIN_LOW    = 130,  
    parameter integer tSDA_SETUP      = 20,   
    parameter integer tSDA_HOLD       = 10,   
    ...
    input  logic [N_MASTERS-1:0] m_nack,     
    input  logic [N_MASTERS-1:0] arb_priority, 

    output logic        timing_violation,     
    output logic        arbitration_lost,     
    output logic        bus_error,            
    output logic        bus_clear,            
    output logic [N_MASTERS-1:0] gain_bus,   
    output logic [31:0] violation_capture,   
