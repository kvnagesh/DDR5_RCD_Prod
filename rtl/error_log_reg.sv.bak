...
module error_log_reg #(
  ...
  input  logic                ecc_err_in,     
  input  logic [15:0]         ecc_err_cnt_in, 
  input  logic                ecc_sbe_in,     
  input  logic                ecc_dbe_in,     
  
  input  logic                crc_err_in,     
  input  logic [15:0]         crc_err_cnt_in, 
  
  input  logic                par_err_in,     
  input  logic [15:0]         par_err_cnt_in, 
  
  input  logic [31:0]         err_addr_in,    
  input  logic [7:0]          err_position_in,
  ...
  output logic [7:0]          error_type_flags, 
...
module error_log_fifo #(
  ...
  input  logic [DATA_WIDTH-1:0] err_data,  
