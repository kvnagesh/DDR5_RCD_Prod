...
module ssc_clk_mod #(
    parameter integer N_PHASE_BITS = 16, 
    ...
    input  logic         ssc_en,         
    input  logic  [1:0]  ssc_profile,    
    input  logic  [N_AMP_BITS-1:0] ssc_mod_depth, 
    input  logic  [N_PHASE_BITS-1:0] ssc_mod_freq, 
    input  logic         ssc_calib_req,  

    // Status/Debug outputs
    output logic         ssc_stat,       
    output logic         ssc_calib_done, 
    output logic [N_AMP_BITS-1:0] ssc_dbg_amp,   
    output logic [N_PHASE_BITS-1:0] ssc_dbg_phase, 
