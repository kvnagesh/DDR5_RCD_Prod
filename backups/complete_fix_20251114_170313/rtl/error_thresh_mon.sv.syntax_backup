...
module error_thresh_mon #(
  parameter int NUM_ERROR_SOURCES = 8,  
  ...
  input  logic [NUM_ERROR_SOURCES-1:0]     error_valid,         
  input  logic [NUM_ERROR_SOURCES-1:0]     error_severity,      
  input  logic [COUNTER_WIDTH-1:0]         error_counts[NUM_ERROR_SOURCES],  
  ...
  input  logic                              threshold_load,      
  
  // System-level status outputs
  output logic                              system_warning,      
  output logic                              system_fail,         
  output logic                              system_fatal,        
  
  // Per-source status
  output logic [NUM_ERROR_SOURCES-1:0]     source_warning,      
  output logic [NUM_ERROR_SOURCES-1:0]     source_fail,         
  output logic [NUM_ERROR_SOURCES-1:0]     source_fatal,        
  
  // Aggregated statistics
  output logic [COUNTER_WIDTH-1:0]         total_errors,        
  output logic [7:0]                       active_error_sources, 
  output logic [2:0]                       max_severity,        
  output logic [7:0]                       severity_histogram[0:3], 
  
  // Interrupt/Alert signals
  output logic                              error_interrupt,     
  output logic                              threshold_crossed,   
