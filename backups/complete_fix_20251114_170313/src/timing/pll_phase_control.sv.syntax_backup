...
module pll_phase_control #(
    parameter int PHASE_RESOLUTION = 256,  
    parameter int DCC_RESOLUTION = 64,     
    ...
    input  logic [7:0]                  pll_multiplier, 
    input  logic [7:0]                  pll_divider,    
    ...
    input  logic [5:0]                  dcc_target,     
    output logic [5:0]                  dcc_current,
    output logic                        dcc_corrected,
    
    // Spread Spectrum Clocking
    input  logic                        ssc_enable,
    input  logic [3:0]                  ssc_range,      
    input  logic                        ssc_center_spread, 
    output logic                        ssc_active,
    
    // Output Clocks
    output logic                        dck_out,        
    output logic                        dck_n_out,      
    output logic                        dck_90_out,     
    output logic                        dck_180_out,    
    output logic                        dck_270_out,    
