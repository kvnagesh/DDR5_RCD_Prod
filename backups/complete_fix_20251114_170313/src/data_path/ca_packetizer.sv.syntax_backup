...
module ca_packetizer #(
  ...
  // Packet Parameters
  parameter int PACKET_SIZE = 14,               
  parameter int CRC_WIDTH = 5,                  
  parameter int PARITY_WIDTH = 1,               
  ...
  input  logic [CMD_WIDTH-1:0]              cmd_in,           
  input  logic [ADDR_WIDTH-1:0]             addr_in,          
  input  logic                              cmd_valid,        
  output logic                              cmd_ready,        

  // Additional Command Information
  input  logic [2:0]                        bank_group,       
  input  logic [1:0]                        bank_addr,        
  input  logic [3:0]                        burst_length,     
  input  logic                              auto_precharge,   

  // CA Output Interface (to DRAM)
  output logic [CA_WIDTH-1:0]               ca_out,           
  output logic                              ca_valid,         
  input  logic                              ca_ready,         

  // CA Phase Outputs (dual-edge)
  output logic [CA_WIDTH-1:0]               ca_phase0,        
  output logic [CA_WIDTH-1:0]               ca_phase1,        
  output logic                              ca_phase_valid,   
