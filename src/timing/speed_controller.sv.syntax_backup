...
module speed_controller #(
  parameter int NUM_SPEED_GRADES = 8,       
  parameter int MAX_FREQ_MHZ = 6400,        
  ...
  // Configuration
  input  logic [2:0]               cfg_speed_grade,  
  input  logic                     cfg_enable,       
  
  // Timing Parameters Output
  output logic [7:0]               tCK,              
  output logic [7:0]               tRCD,             
  output logic [7:0]               tRP,              
  output logic [7:0]               tCL,              
  
  // Bus Handshake Signals
  output logic                     req_valid,        
  input  logic                     req_ready,        
  output logic [2:0]               req_speed,        
  
  // Status Signals
  output logic                     speed_valid,      
  output logic [2:0]               current_speed,    
  output logic [11:0]              current_freq_mts, 
  output logic                     speed_changing,   
